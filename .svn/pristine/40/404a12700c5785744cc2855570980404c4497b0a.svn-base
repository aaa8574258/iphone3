...
-(void)makeUI{
    ...
    //可选规格
    self.selectBig = [[UILabel alloc] initWithFrame:CGRectMake(self.allWidth - 100 * self.numSingleVersion - 30 * self.numSingleVersion - 10 * self.numSingleVersion - 20 * self.numSingleVersion, 50 * self.numSingleVersion, 50 * self.numSingleVersion, 20 * self.numSingleVersion)];
