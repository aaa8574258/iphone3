...
- (void)makeMainView{
  ...
  //  timeLab.font = [UIFont systemFontOfSize:14];
    ...
    self.countDownView.frame = CGRectMake(WIDTH_CONTROLLER - 80 * self.numSingleVesion -  timeLab.frame.size.width, height, WIDTH_CONTENTVIEW - 80 * self.numSingleVesion - timeLab.frame.size.width, 30 * self.numSingleVesion);
