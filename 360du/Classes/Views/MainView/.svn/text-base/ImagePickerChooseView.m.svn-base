...
@property (nonatomic,strong)ImagePickerBlock1 ImagePickerblock1;
...
//-(void)setImagePickerblock1:(ImagePickerBlock1)block
//{
//    self.ImagePickerblock1 = block;
//}
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    //拍照
    if (indexPath.row == 0) {
        self.ImagePickerblock1();
