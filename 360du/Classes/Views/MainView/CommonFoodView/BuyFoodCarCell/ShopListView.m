...
-(void)makeUI{
    ...
    for (NSInteger i = 0; i < self.priceArr.count; i++) {
        ...
        self.addBtn.frame = CGRectMake(WIDTH_VIEW  - 30 * self.numSingleVesion, 5 * self.numSingleVesion + 30 * self.numSingleVesion * i, 20 * self.numSingleVesion, 20 * self.numSingleVesion);
        ...
        self.reduceBtn.frame = CGRectMake(WIDTH_VIEW  - 30 * self.numSingleVesion - 10 * self.numSingleVesion - 20 * self.numSingleVesion, 5 * self.numSingleVesion + 30 * self.numSingleVesion * i, 20 * self.numSingleVesion, 20 * self.numSingleVesion);
        ...
        //买几个
        self.buyCount = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH_VIEW  - 30 * self.numSingleVesion - 10 * self.numSingleVesion, 10 * self.numSingleVesion + 30 * self.numSingleVesion * i, 10 * self.numSingleVesion, 10 * self.numSingleVesion)];
        ...
        self.buyCount.center = CGPointMake(self.frame.size.width  - 30 * self.numSingleVesion - 5 * self.numSingleVesion, 15 * self.numSingleVesion + 30 * self.numSingleVesion * i);
        ...
        self.priceLable.center = CGPointMake(WIDTH_VIEW - 30 * self.numSingleVesion - 10 * self.numSingleVesion - 20 * self.numSingleVesion - 5 * self.numSingleVesion - self.priceLable.frame.size.width / 2, 15 * self.numSingleVesion + 30 * self.numSingleVesion * i);
        //数量
