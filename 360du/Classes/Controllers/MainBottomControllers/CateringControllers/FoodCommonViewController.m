...
-(void)makeNav{
    ...
    leftBtn.frame = CGRectMake(WIDTH_CONTROLLER - 32 , (44 - 20) / 2, 15, 20);
    [leftBtn setImage:[UIImage imageNamed:@"fanhuijian02.png"] forState:UIControlStateNormal];
...
- (void)menu:(JSDropDownMenu *)menu didSelectRowAtIndexPath:(JSIndexPath *)indexPath {
    ...
    if (indexPath.column == 3) {
        ...
        FoodListCategoryModel *model = self.cateAndSortAndWefAndCommArr[indexPath.column][indexPath.row];
        [self returnHeadBtn:indexPath.column andHeadString:model.pid];
    }
