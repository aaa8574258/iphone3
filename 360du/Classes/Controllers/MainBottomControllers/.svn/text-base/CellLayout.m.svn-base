...
- (id)initWithStatusModel:(StatusModel *)statusModel
    ...
    if (self) {
        ...
        if ([[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:MESSAGE_TYPE_WEBSITE]) {

            contentTextStorage.text = @"";
        }else{
        ...
        //图片类型
        if ([[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:MESSAGE_TYPE_IMAGE]) {
            NSInteger row = 0;
            NSInteger column = 0;
            if (imageCount == 1) {
        ...
        //网页链接类型
        else if ([[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:MESSAGE_TYPE_WEBSITE]) {
            //这个CGRect用来绘制背景颜色
            ...
            [detailTextStorage lw_addLinkForWholeTextStorageWithData:statusModel.content
                                                      highLightColor:RGB(0, 0, 0, 0.15)];
            [self addStorage:detailTextStorage];
        }
        
        //视频类型
        else if ([[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:MESSAGE_TYPE_VIDEO]) {
            //TODO：
        ...
        if (![[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:MESSAGE_TYPE_VIDEO]) {
            ...
            dateTextStorage.frame = CGRectMake(nameTextStorage.left,
                                               ...
                                               SCREEN_WIDTH - 80.0f,
                                               CGFLOAT_MAX);
            _deletBtnRect = CGRectMake(SCREEN_WIDTH - 194.0f,
                                       20.0f + contentTextStorage.bottom - 14.5f,
                                       44.0f,
                                       30.0f);
            if (lastImageStorage) {
                menuPosition = CGRectMake(SCREEN_WIDTH - 54.0f,
                ...
                dateTextStorage.frame = CGRectMake(nameTextStorage.left,
                                                   ...
                                                   CGFLOAT_MAX);
                _deletBtnRect = CGRectMake(SCREEN_WIDTH - 194.0f,
                                           20.0f + lastImageStorage.bottom - 14.5f,
                                           44.0f,
                                           30.0f);
            }
        }
...
//            NSMutableArray *ids = [[NSMutableArray alloc] initWithCapacity:statusModel.commentListIds.count];
...
//            for (NSDictionary *dic in statusModel.commentListIds) {
//                NSString *toid = dic[@"to"];
//                if (toid.length != 0) {
//                    CommentModel *model1 = [[CommentModel alloc] init];
//                    model1.fromId = dic[@"from"];
//                    model1.toId =  dic[@"to"];
//                    model1.mcid = dic[@"mcid"];
//                    
//                }
//            }
            NSInteger i = 0;
            for (NSDictionary* commentDict in statusModel.commentListIds) {
                NSString* to = commentDict[@"to_nickName"];
                if (to.length != 0) {
                    NSString* commentString = [NSString stringWithFormat:@"%@回复%@:%@",
                                               commentDict[@"from_nickName"],
                                               commentDict[@"to_nickName"],
                                               commentDict[@"commentContent"]];
                    ...
                    commentModel1.to = commentDict[@"from_nickName"];
                    commentModel1.index = index;
                    commentModel1.i = i;
                    commentModel1.toId = commentDict[@"from_memberId"];
                    commentModel1.mcid = commentDict[@"mcid"];
                    NSLog(@"%@--%ld",commentModel1.to,(long)commentModel1.index);
                    ...
                    [commentTextStorage lw_addLinkWithData:commentModel1
                                                     range:NSMakeRange(0,[(NSString *)commentDict[@"from_nickName"] length])
                                                 linkColor:RGB(113, 129, 161, 1)
                                            highLightColor:RGB(0, 0, 0, 0.15)];
                    
                    CommentModel* commentModel2 = [[CommentModel alloc] init];
                    commentModel2.to = [NSString stringWithFormat:@"%@",commentDict[@"to_nickName"]];
                    commentModel2.index = index;
                    commentModel2.toId = commentDict[@"to_memberId"];
                    commentModel2.mcid = commentDict[@"mcid"];
                    commentModel2.i = i;

//                    commentModel2.toId = [NSString stringWithFormat:@"%@"]
                    NSLog(@"%@--%ld",commentModel2.to,(long)commentModel2.index);
                    [commentTextStorage lw_addLinkWithData:commentModel2
                                                     range:NSMakeRange([(NSString *)commentDict[@"from_nickName"] length] + 2,
                                                                       [(NSString *)commentDict[@"to_nickName"] length])
                                                 linkColor:RGB(113, 129, 161, 1)
                                            highLightColor:RGB(0, 0, 0, 0.15)];
                    ...
                    CommentModel* commentModel = [[CommentModel alloc] init];
                    commentModel.to = commentDict[@"from_nickName"];
                    commentModel.index = index;
                    commentModel.toId = commentDict[@"from_memberId"];
                    commentModel.mcid = commentDict[@"mcid"];
                    commentModel.i = i;
            ...
            commentBgStorage.contents = [UIImage imageNamed:@"commentContent"];
...
- (id)initContentOpendLayoutWithStatusModel:(StatusModel *)statusModel
    ...
    if (self) {
        ...
        //菜单按钮
        CGRect menuPosition = CGRectZero;
        if (![[NSString stringWithFormat:@"%@",statusModel.type] isEqualToString:@"video"]) {
            menuPosition = CGRectMake(SCREEN_WIDTH - 54.0f,
                                      10.0f + contentTextStorage.bottom - 14.5f,
                                      44.0f,
                                      44.0f);
