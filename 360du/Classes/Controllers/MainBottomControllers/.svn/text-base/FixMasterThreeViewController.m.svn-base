//
//  FixMasterThreeViewController.m
//  360du
//
...
@interface FixMasterThreeViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic ,strong) UITableView *tableView;
@property (nonatomic ,strong) NSMutableArray *dataArr;
@property (nonatomic ,strong) NSArray *imageArr;
@end

@implementation FixMasterThreeViewController
...
-(void)viewWillAppear:(BOOL)animated{
    [self makeTable];
    [self loadData:[NSString stringWithFormat:FIXMASTERMAIN,[StoreageMessage getMessage][2],@"3",@"1",@"1000"]];
}
