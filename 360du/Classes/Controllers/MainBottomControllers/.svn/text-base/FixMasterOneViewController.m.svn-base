...
@interface FixMasterOneViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FixMasterOneViewController
...
-(void)viewWillAppear:(BOOL)animated{
    [self makeTable];
    [self loadData:[NSString stringWithFormat:FIXMASTERMAIN,[StoreageMessage getMessage][2],@"1",@"1",@"1000"]];
