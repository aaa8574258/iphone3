 ...
 *  @return 示例对象
 */
- (instancetype)initWithFrame:(CGRect)frame andViewArr:(NSArray<UIView *> *)vcArr andTitleArr:(NSArray <NSString *>*)titleArr lineHeight:(CGFloat)lineHeight andView:(UIView *)view;
